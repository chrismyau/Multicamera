...
def main():
    ...
    for frame in videostream.stream_video(0):  
        ...
        _, sorted_indices = torch.sort(boxes.data[:, 4], descending=True)
        ...
        for box in sorted_boxes:
            ...
            if confidence > CONFIDENCE_THRESHOLD:
                ...
                if focus_budget > 0:
                    ...
                    sub_detections = model(subpatch)[0]
                    ...
                    for sub_box in sub_detections.boxes.data:
                        ...
                        if sub_confidence > CONFIDENCE_THRESHOLD:
                            ...
                            if sub_label not in global_detected_objects:
                                sub_confidence = sub_confidence * len(global_detected_objects) + 1 / len(global_detected_objects)
        ...
        if global_confidences and focus_confidences:
